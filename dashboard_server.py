...
function cellStyle(pct){
  ...
  const neg=[[255,232,225],[255,224,216],[255,220,210],[254,212,204],[253,205,197],[252,195,186],[250,185,175],[248,176,167],[246,168,160],[244,163,156],[243,158,152],[242,154,149],[240,150,145]];
  if(pct>=6.5){r=250;g=170;b=225}else if(pct>=0.05){[r,g,b]=pos[Math.min(pos.length-1,Math.floor((pct-0.05)/0.5))]}
  else if(pct>-0.05){r=245;g=245;b=200}else if(pct>=-6.5){[r,g,b]=neg[Math.min(neg.length-1,Math.floor((Math.abs(pct)-0.05)/0.5))]}
