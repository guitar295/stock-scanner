  ...
  <div class="hv-header-row1">
    ...
    <div style="display:flex;gap:6px;align-items:center;margin-left:auto;flex-shrink:0;padding-right:6px;">
      ...
      <button onclick="toggleHoverPreview()"
        ...
        onmouseout="this.style.background='#fff';this.style.color='var(--muted)';this.style.borderColor='var(--border)'"
        style="width:24px;height:24px;border-radius:4px;border:1px solid var(--border);background:#fff;color:var(--muted);font-size:12px;font-family:var(--font-mono);cursor:pointer;display:inline-flex;align-items:center;justify-content:center;line-height:1;transition:all .15s;">✕</button> 
    </div>
  </div>
  <div class="hv-body">
