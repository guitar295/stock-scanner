...
.hv-sym-item { display:grid;grid-template-columns:30px 1fr;align-items:center;padding:5px 4px;cursor:pointer;border-bottom:1px solid rgba(0,0,0,.04);transition:background .1s;gap:4px; }
