...
Nội dung: Copy toàn bộ code trong phần bạn đã paste ở trên, bỏ dòng đầu tiên này đi (vì Docker không dùng lệnh pip kiểu Colab):

python# Xoá dòng này trước khi paste lên GitHub:
